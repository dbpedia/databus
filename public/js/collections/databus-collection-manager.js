class DatabusCollectionManager {
  ...
  initialize(remoteCollections) {
      ...
      let activeIdentifier = window.localStorage.getItem(this.storageKey + '_active');
      ...
      window.sessionStorage.setItem(this.storageKey + '_isInitialized', 'true');
    ...
    findActive() {
      ...
      this.activeCollectionIdentifier = window.localStorage.getItem(this.storageKey + '_active');
    ...
    get isInitialized() {
      return window.sessionStorage.getItem(this.storageKey + '_isInitialized') === 'true';
    }
     ...
     */
    selectFirstOrCreate() {
      this.activeCollectionIdentifier = null;
      for (let identifier in this.local) {
        this.activeCollectionIdentifier = identifier;
        break;
      }
